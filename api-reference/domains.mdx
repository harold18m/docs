...
Configuración de DNS en un clic. Si el proveedor DNS del dominio soporta el estándar [Domain Connect](https://www.domainconnect.org/), retorna una URL firmada que crea los 8 registros automáticamente: el usuario final solo confirma en la pantalla de su proveedor, sin copiar nada a mano.
