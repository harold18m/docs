...
> **Supresión:** igual que en `/v1/send-email`, se aplica al procesar cada envío en segundo plano — los destinatarios suprimidos se omiten y su actividad queda con estado `suppressed`.
...
> **Tip:** Para más de 10,000 destinatarios, usa múltiples llamadas o crea una campaña desde el Dashboard de RQE, que maneja lotes y reintentos automáticamente. Ver más en [Campañas](/api-reference/campaigns).
