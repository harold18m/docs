...
One-click DNS setup. If the domain's DNS provider supports the [Domain Connect](https://www.domainconnect.org/) standard, this returns a signed URL that creates all 8 records automatically: the end user just confirms on their provider's screen, with nothing to copy by hand.
