...
<Info>
  Hoy el servidor es de **solo lectura**: tu asistente puede consultar y analizar, no modificar ni enviar. La escritura (crear contactos, segmentos, campañas en borrador) y el envío llegarán en fases siguientes, siempre detrás de permisos que tú concedes.
</Info>
...
<Tip>
  Empieza con el mínimo. Si solo quieres que el asistente analice el desempeño de tus campañas, `campaigns:read` y `reports:read` bastan.
</Tip>
...
Hoy no. El servidor es de solo lectura. Cuando se habilite la escritura, será mediante permisos `:write` separados que tendrás que conceder explícitamente, y las acciones con efecto (crear una campaña) nacerán en borrador para que tú las revises y las actives desde la app.
</Accordion>
