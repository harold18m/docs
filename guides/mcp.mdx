...
| `generate_template` | `templates:write` | El motor de diseño escribe un email completo a partir de un brief, con la identidad de marca del proyecto, y lo guarda como plantilla. Tarda entre 30 y 90 segundos y consume el tope diario de IA del proyecto |
| `edit_template_with_ai` | `templates:write` | Reescribe una plantilla existente siguiendo una instrucción en lenguaje natural, conservando su id. Solo para plantillas con diseño editable (las importadas como HTML crudo usan `update_template`) |
...
| `AI_QUOTA_EXCEEDED` | El proyecto agotó sus generaciones por IA de hoy (se reinicia a las 00:00 UTC) — escribe el HTML con `create_template` o `update_template`, o reintenta mañana |
